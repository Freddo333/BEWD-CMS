			...
			function () {
					...
					if ( ! Element.prototype.matches ) {
						Element.prototype.matches =
							...
							function( s ) {
								...
								while ( --i >= 0 && matches.item( i ) !== this ) { // TODO: Check and remove this empty loop
								}
				...
				if ( null !== searchIcon ) {
					...
					document.addEventListener(
						'keyup',
						function ( e ) {
							if ( searchBox.classList.contains( 'show-search' ) && 27 === e.keyCode ) { // TODO: Deprecated symbool (keyCode) used.
								showHideSearchForm( 'hide' );
							}
						}
					);
